#
# Heat map helper function, taken from
...
def heatmap(data, row_labels, col_labels, ax=None, rotation=-30, ha="right",
    ...
    **kwargs
    ...
    for i in range(data.shape[0]):
        for j in range(data.shape[1]):
            ...
            if data[i, j] < 1e4:
                x = valfmt(data[i, j], None)
            else:
                e = int(np.log10(data[i, j]))
                v = data[i, j] / (10 ** e)
                x = r'${:.1f} \times 10^{:d}$'.format(v, e)
